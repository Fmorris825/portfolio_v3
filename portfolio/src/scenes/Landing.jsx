      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            ...
            interfaces with Code. Specialization with React.js
          </p>
        </motion.div>
        {/* Call to Actions */}
        <motion.div
        ...
        >
          ...
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-deep-blue hover:text-red transition duration-500 w-full h-full flex items-center justify-center px-10 font-playfair drop-shadow-sm">
              Let's talk.
            </div>
          </AnchorLink>
        </motion.div>
